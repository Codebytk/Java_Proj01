...
class MethodOverloading{
	// 메소드 오버로딩 : 동일한 이름의 메소드를 시그니처에 따라서 다른 매소드를 호출하는것
			// 		시그니처 : 메소드의 인풋 매개변수 갯수, 인풋되는 타입이 다를 경우 다른 메소드로 식별
	
	void print() { //print (): 인풋 매개변수가 없는 매소드
		
		System.out.println("데이터가 없습니다. ");
		
	}
	void print (int a) { //print(int a) : 인풋 매개 변수에 정수 1개를 인풋받는 메소드
...
public class Method_Overloading {
	...
	public static void main(String[] args) {
		...
		// 메소드 오버라이딩 : 상속 에서만 적용됨
			//부모 클래스에서 선언된 메소드를 자식 클래스에서 재정의 해서 사용하는것
