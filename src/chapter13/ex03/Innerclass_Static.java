...
/*
 	static Inner Class : 외부 클래스에서 인스턴스 필드, 인스턴스 메소드는 static Inner Class 블락에 올수없다.
 		// 외부클래스의 정적 필드 , 정적 메소드만 Static Inner Class 블락에 올 수 있다.
...
class A { // Outer class
	...
	// 외부 클래스에서 메소드 선언
	void method1() {
		System.out.println("Instancd Method");
	}
	...
	static class B { // static 이너 클래스 : static 필드, static 메소드만 포함할수 있다.
		void bcd() {
