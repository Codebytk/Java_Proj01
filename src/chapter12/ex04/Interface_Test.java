...
// 한번만 사용하고 버릴 경우, 별도의 클래스를 만들지 않고 바로 출력
...
public class Interface_Test {
	...
	public static void main(String[] args) {
		...
		// 매번 자주 사용할 경우 구현된 자식클래스를 생성후 출력
		A a1 = new Aa();
		a1.abc();
		...
		// 2. 구현된 자식클래스를 생성하지 않고 익병클래스로 출력
		// B 는 인터페이스여서 객체를 생성할수 없다.
		B b1 = new B() {
			@Override
			public void bcd() {
		...
		B b2 = new B() {
			@Override
			public void bcd() {
				System.out.println("객체생성 없이 바로 오버라이딩 됨");			
			}
		};
		b2.bcd();
	}
