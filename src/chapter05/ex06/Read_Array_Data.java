...
public class Read_Array_Data {
	...
	public static void main(String[] args) {
		// arr1,length: 
			...
			//2차원 배열일떄 -배열 방의 행의 갯수를 출력
				//arr1[0].length:0번 행의 열의 갯수 출력
		...
		System.out.println(arr2.length);          //2        // 2차원 배열 행의 갯수 출력
		...
		for (int i = 0; i < arr3.length; i++) { // i : 행의 방번호, arr3.length :행의 갯수
			//행의 정보를 출력
			for(int j=0; j < arr3[i].length; j++) {//j :열의 방번호, arr3[i].length:행의 열 갯수
				//열의 정보를 출력
