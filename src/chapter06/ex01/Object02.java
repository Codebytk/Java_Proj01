...
// 외부 클래스: 객체를 생성하기 위한 설계도, 템플릿(툴)
class A{
	// 필드(field), 멤버 피드, 멤버 변수: 클래스 블락에서 선언된 변수 
	int m = 3;
	int n = 7;
	double d = 10.5;
	...
	//메소드 : 함수, 호출시 작동됨,
	// void : 리턴 타입 print : 메소드 명(인풋 매개변수){ 메소드 호출시 프로그램 실행코드}
...
public class Object02 {
	...
	public static void main(String[] args) {
		...
		//타입 자료형
		//클래스 명 참조 변수= new A();
		//A : 객체자료형, 동일한 패키지 내에 클래스가 존재할때 import 없이 사용가능
		...
		System.out.println("======================================");
		// 하나의 클래스를 생성하면 클래스를 기준으로 여러개의 객체를 생성 할수 있다.
